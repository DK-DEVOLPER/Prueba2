...
function getMessageConfig() {
	...
	const bye = 'Bye bye @user, seguro se notara tu ausencia!'
	const spromote = '@user ahora es admin!'
	const sdemote = '@user ya no es admin!'
	const sDesc = 'La descripción cambio a \n@desc'
	const sSubject = 'El nombre del grupo cambio a \n@subject'
	const sIcon = 'El icono del grupo fue actualizado!'
	const sRevoke = 'El nuevo link del grupo es \n@revoke'
