...
let handler = async (m, { conn, usedPrefix: _p, __dirname }) => {
	try {
		...
		await conn.sendFThumb(m.chat, db.data.datas.maingroupname, text.replace(`fire <url>`, `fire <url>${readMore}`).trim(), "https://telegra.ph/file/93cbd611c6b7c00a3072f.jpg", db.data.datas.linkgc, m)
	} catch (e) {
		console.log(e)
	}
}
