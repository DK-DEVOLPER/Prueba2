...
let handler = async (m, { conn, usedPrefix: _p, __dirname }) => {
	try {
		...
		await conn.sendFThumb(m.chat, db.data.datas.maingroupname, text.replace(`flower <text>`, `flower <text>${readMore}`).trim(), "https://telegra.ph/file/865963e03ed7ee8fe5fed.jpg", db.data.datas.linkgc, m)
	} catch (e) {
		console.log(e)
	}
}
