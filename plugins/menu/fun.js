...
let handler = async (m, { conn, usedPrefix: _p, __dirname }) => {
	try {
		...
		await conn.sendFThumb(m.chat, db.data.datas.maingroupname, text.replace(`build [item] [monto]`, `build [item] [monto]${readMore}`).trim(), 'https://telegra.ph/file/af713b0047b895285b166.png', db.data.datas.linkgc, m)
	} catch (e) {
		console.log(e)
	}
}
