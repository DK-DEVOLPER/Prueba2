...
let handler = async (m, { conn, usedPrefix: _p, __dirname }) => {
	try {
		...
		await conn.sendFThumb(m.chat, db.data.datas.maingroupname, text.replace(`addjoindurasi`, `addjoindurasi${readMore}`).trim(), "https://telegra.ph/file/b97098c2c2ed103415885.jpg", db.data.datas.linkgc, m)
	} catch (e) {
		console.log(e)
	}
}
