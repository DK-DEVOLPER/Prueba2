...
let handler = async (m, { conn, usedPrefix: _p, __dirname }) => {
	try {
		...
		await conn.sendFThumb(m.chat, db.data.datas.maingroupname, text.replace(`PIC* 」`, `PIC* 」${readMore}`).trim(), "https://telegra.ph/file/9dbbd926ebed68e6bd758.png", db.data.datas.linkgc, m)
	} catch (e) {
		console.log(e)
	}
}
