...
let handler = async (m, { conn, usedPrefix: _p, __dirname }) => {
	try {
		...
		await conn.sendFThumb(m.chat, db.data.datas.maingroupname, text.replace(`<nuke_code>`, `<nuke_code>${readMore}`).trim(), "https://telegra.ph/file/a18433b025089b3229086.jpg", db.data.datas.linkgc, m)
	} catch (e) {
		console.log(e)
	}
}
