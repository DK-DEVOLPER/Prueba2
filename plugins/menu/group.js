...
let tagsgroup = {
	'group': '*Algunos privilegios de administrador*'
}
const defaultMenu = {
	before: `
━ ━ *[ 👥 FUNCIONES DE GRUPO ]* ━ ━
...
let handler = async (m, { conn, usedPrefix: _p, __dirname }) => {
	try {
		...
		await conn.sendFThumb(m.chat, db.data.datas.maingroupname, text.replace(`demote @tag`, `demote @tag${readMore}`).trim(), "https://telegra.ph/file/102788e5d844911f77bb1.jpg", db.data.datas.linkgc, m)
	} catch (e) {
		console.log(e)
	}
}
