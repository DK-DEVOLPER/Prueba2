...
let handler = m => m
	...
	let timeh = `🕰️ ${d.toLocaleTimeString('es', { hour: 'numeric', minute: 'numeric', second: 'numeric' }).replaceAll('.',':')}`
	...
	global.timeh = `🕰️ ${d.toLocaleTimeString('es', { hour: 'numeric', minute: 'numeric', second: 'numeric' }).replace(/./,':')}`
