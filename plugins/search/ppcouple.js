let handler = async (m, { conn, usedPrefix, command }) => {
	try {
		...
		anu = anu.hasil
		await conn.sendMsg(m.chat, { image: { url: anu.cowok }, caption: `chico` }, { quoted: m })
		await conn.sendMsg(m.chat, { image: { url: anu.cewek }, caption: `chica` }, { quoted: m })
	} catch (e) {
		console.log(e)
		try {
		let anu = pepe.getRandom()
			await conn.sendMsg(m.chat, { image: { url: anu.male }, caption: `chico` }, { quoted: m })
			await conn.sendMsg(m.chat, { image: { url: anu.female }, caption: `chca` }, { quoted: m })
		} catch (e) {
			console.log(e)
